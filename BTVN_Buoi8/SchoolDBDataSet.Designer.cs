...
namespace BTVN_Buoi7 {
    ...
    public partial class SchoolDBDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow AddStudentsRow(int Student, string FullName, int Age, string Major) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentsRow FindByStudent(int Student) {
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public int Student {
                get {
                    return ((int)(this[this.tableStudents.StudentColumn]));
                }
                set {
                    this[this.tableStudents.StudentColumn] = value;
                }
            }
...
namespace BTVN_Buoi7.SchoolDBDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Students] WHERE (([Student] = @Original_Student) AND ([FullNam" +
                "e] = @Original_FullName) AND ([Age] = @Original_Age) AND ([Major] = @Original_Ma" +
                "jor))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Students] ([Student], [FullName], [Age], [Major]) VALUES (@Stu" +
                "dent, @FullName, @Age, @Major);\r\nSELECT Student, FullName, Age, Major FROM Stude" +
                "nts WHERE (Student = @Student)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [Student] = @Student, [FullName] = @FullName, [Age] = @Age, [Major] = @Major WHERE (([Student] = @Original_Student) AND ([FullName] = @Original_FullName) AND ([Age] = @Original_Age) AND ([Major] = @Original_Major));
SELECT Student, FullName, Age, Major FROM Students WHERE (Student = @Student)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::BTVN_Buoi7.Properties.Settings.Default.SchoolDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Student, FullName, Age, Major FROM dbo.Students";
        ...
        public virtual int Delete(int Original_Student, string Original_FullName, int Original_Age, string Original_Major) {
        ...
        public virtual int Insert(int Student, string FullName, int Age, string Major) {
        ...
        public virtual int Update(int Student, string FullName, int Age, string Major, int Original_Student, string Original_FullName, int Original_Age, string Original_Major) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FullName, int Age, string Major, int Original_Student, string Original_FullName, int Original_Age, string Original_Major) {
            return this.Update(Original_Student, FullName, Age, Major, Original_Student, Original_FullName, Original_Age, Original_Major);
        }
    }
